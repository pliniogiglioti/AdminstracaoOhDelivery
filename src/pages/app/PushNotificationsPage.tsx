        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="mt-1 text-xs text-ink-400">
              No app, o token fica em <code className="rounded bg-ink-50 px-1">localStorage</code> com a chave <code className="rounded bg-ink-50 px-1">oh_delivery_push_token</code>
            </p>
          </div>
          <button
            type="button"
